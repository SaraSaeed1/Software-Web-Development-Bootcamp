...
<body>
    ...
    <div class="container col-6">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <c:forEach var ="expense" items="${expenses}">
                        <tr>
                            <td><a href="/expenses/show/${expense.id}"><c:out value="${expense.expense}"/></a></td>
                            <td><c:out value="${expense.vendor}"/></td>
                            <td><c:out value="${expense.amount}"/></td>
                            <td><a class="badge bg-warning text-wrap" href="/expenses/edit/${expense.id}">Edit</a></td>
                            <td><a class="badge bg-danger text-wrap"  href="delete/${expense.id}">Delete</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
        ...
        <div class="m-4">
            ...
            <form:form class ="align-items-center" action="/expenses" method="post" modelAttribute="ex">
