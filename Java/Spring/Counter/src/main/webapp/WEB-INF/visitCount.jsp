...
<body>
    <div class="container">
        <div class="mt-4 text-center mb-4">
            <h4 class="text-dark" >You have visited <a href="/your_server/counter">http://your_server</a> <c:out value="${count}"/></h4>
        </div>
        <div class="d-flex justify-content-around">
            ...
            <a type="button" class="btn btn-outline-secondary" href="/your_server/back_to_zero2">Back to zero</a> 
        </div>
    </div>
</body>
</html>